...
package com.monosky.zhihudaily.widget;
...
public class RecycleViewHeader extends RelativeLayout {
     ...
     */
    public static RecycleViewHeader fromXml(Context context, @LayoutRes int layoutRes) {
        RecycleViewHeader header = new RecycleViewHeader(context);
    ...
    public RecycleViewHeader(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void setupAlignment(RecyclerView recycler) {
        if (!mAlreadyAligned) {
            ...
            RecycleViewHeader.this.setLayoutParams(newHeaderParams);
            ...
            if (currentParent instanceof ViewGroup) {
                ...
                newRootParent.addView(RecycleViewHeader.this);
    ...
    private void setupHeader(final RecyclerView recycler) {
        recycler.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                mCurrentScroll += dy;
                RecycleViewHeader.this.setTranslationY(-mCurrentScroll);
            }
        });

        RecycleViewHeader.this.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            @Override
            public void onGlobalLayout() {
                int height = RecycleViewHeader.this.getHeight();
                if (height > 0) {
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.JELLY_BEAN) {
                        RecycleViewHeader.this.getViewTreeObserver().removeOnGlobalLayoutListener(this);
                    } else {
                        RecycleViewHeader.this.getViewTreeObserver().removeGlobalOnLayoutListener(this);
                    }
