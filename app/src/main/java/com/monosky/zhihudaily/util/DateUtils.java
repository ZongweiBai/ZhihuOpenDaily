...
public class DateUtils {
    ...
    public static SimpleDateFormat sdfEEEE = new SimpleDateFormat("EEEE");
     ...
     * @return
     */
    public static String getDataFromLong(Long milliseconds) {
        Long timestamp = milliseconds * 1000;
        return sdfMDHm.format(new java.util.Date(timestamp));
    }
     ...
     * @return 08月28日 星期五
     */
    public static String getFormatData(String formate) {
        try {
            Date date = sdf.parse(formate);
            return sdfmm.format(date) + "月" + sdfdd.format(date) + "日 " + sdfEEEE.format(date);
     ...
     * @return
     */
    public static String getPastOneDay(String dataStr) {
        try {
